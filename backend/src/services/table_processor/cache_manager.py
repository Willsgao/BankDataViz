# 文件：backend/src/services/table_processor/cache_manager.py
"""
缓存管理工具 - 用于手动清理和查看缓存
"""
...
from backend.src.services.table_processor.cache_gateway import (
...
def main():
    ...
    if not test_connection():
        ...
        print("可以使用以下命令初始化表:")
        print("  from backend.src.services.table_processor.cache_gateway import ensure_table")
        print("  ensure_table()")
        return
