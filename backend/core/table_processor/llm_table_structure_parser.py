...
from backend.core.table_processor.cache_gateway import get as cache_get, upsert as cache_upsert, delete as cache_delete
from backend.core.table_processor.object_store import get_object, put_object, extract_pdf_uuid_from_image_path
