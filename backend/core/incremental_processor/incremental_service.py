...
文件：backend/core/services/incremental_processor/incremental_service.py
"""
...
from backend.core.incremental_processor.simple_incremental_processor import SimpleIncrementalProcessor
